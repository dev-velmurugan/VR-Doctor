...
const PatientRegistrationForm = () => {
  ...
  const [patientType, setPatientType] = useState(null); // 'In-Patient' or 'Out-Patient'
  const [mobileNumber, setMobileNumber] = useState('');
  const [city, setCity] = useState('');
  const [patientId, setPatientId] = useState('0012-5369-5824'); // Static for now, or generate dynamically

  const GenderOption = ({ label, iconName, selected, onPress }) => (
    <TouchableOpacity
  ...
  const PatientTypeOption = ({ label, selected, onPress }) => (
    <TouchableOpacity
  ...
  return (
    <ScrollView className="flex-1 p-5 bg-white">
      ...
      <View className="flex-row justify-end mb-5">
        <Text className="text-sm text-gray-700">Patient ID : </Text>
      ...
      {/* Patient Full Name */}
      <Text className="text-base mb-2 text-gray-700">Patient full name?</Text>
      ...
      {/* Patient Age */}
      <Text className="text-base mb-2 text-gray-700">Patient age?</Text>
      <View className="bg-gray-100 rounded-lg mb-4 px-4 h-12 justify-center">
        <TextInput
          className="text-base text-gray-700 flex-1"
          placeholder="23"
      ...
      {/* Patient Gender */}
      <Text className="text-base mb-2 text-gray-700">Patient gender?</Text>
      ...
      {/* Patient Type */}
      <Text className="text-base mb-2 text-gray-700">Patient type</Text>
      <View className="flex-row justify-between mb-5">
        <PatientTypeOption
          label="In-Patient"
      ...
      {/* Patient Mobile */}
      <Text className="text-base mb-2 text-gray-700">Patient mobile</Text>
      ...
      {/* Patient Address */}
      <Text className="text-base mb-2 text-gray-700">Patient address</Text>
      <View className="bg-gray-100 rounded-lg mb-4 px-4 h-12 justify-center">
        <TextInput
          className="text-base text-gray-700 flex-1"
          placeholder="City"
